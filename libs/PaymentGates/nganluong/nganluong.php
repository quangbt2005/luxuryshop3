...
class NL_Checkout
{
	...
	// Mã merchante site
	private $merchant_site_code = '18292';	// Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass= 'mi@1lau'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site

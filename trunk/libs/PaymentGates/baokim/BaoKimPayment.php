...
class BaoKimPayment
{
	...
	// Mã merchante site
	private $merchant_id = '625';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'df4530d7d870afff'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
